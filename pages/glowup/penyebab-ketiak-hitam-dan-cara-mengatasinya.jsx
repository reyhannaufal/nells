            ...
            <div className='mt-10 text-base font-normal space-y-7 font-secondary'>
               <p className='first-letter:font-semibold first-letter:text-xl'>
                  ...
                  <ul className='mt-2 ml-8 list-decimal'>
                     <li>
                        Sebelum nencukur bulu ketiak gunakan krim/ gel cukur dan
                        pastikan kondisi kulit ketiak lembab dan bersih.
                     </li>
                     <li>
                        Gunakan pisau cukur yang tajam dan berkualitas baik.{' '}
                     </li>
                     <li>
                        Cukur dari arah tumbuh rambut, lalu cukur kembali dari
               ...
               <p>
                  Kulit ketiak yang habis dicukur akan semakin kering sehingga
                  lebih rentan terhadap iritasi. Karena itu, jangan lupa untuk
                  menggunakan deodoran NELL’S. NELL’S memiliki kandungan VCO
                  yang dapat melembabkan kulit ketiak dan terdapat senyawa
                  geraniol sebagai anttinflamasi untuk merawat kulit ketiak
                  setelah pencukuran. Selain itu NELL’S bebas (tidak mengandung)
                  dari aluminium yang dapat menyebabkan iritasi dan menghitamkan
                  kulit ketiak.
               </p>
            </div>
         </section>
