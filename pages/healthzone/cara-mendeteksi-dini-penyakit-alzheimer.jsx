         ...
         <section className='max-w-sm pt-10 pb-20 mx-auto xl:px-0 px-7 lg:max-w-5xl'>
            ...
            <div className='px-4 mt-10 text-base font-normal lg:px-0 space-y-7 font-secondary'>
               <p className='first-letter:font-semibold first-letter:text-xl'>
                  ...
                  penurunan memori, bahasa, pemecahan masalah dan keterampilan
                  kognitif lainnya yang mempengaruhi kemampuan seseorang untuk
                  melakukan kegiatan sehari-hari. Penurunan ini terjadi karena
                  sel-sel saraf (neuron) di bagian otak yang terlibat dalam
                  fungsi kognitif telah rusak dan tidak lagi berfungsi normal.
               </p>
               <p>
                  Salah satu titik kritis pada penanganan Alzheimer adalah saat
                  mendeteksi gejala yang muncul. Adapun beberapa kerusakan otak
                  yang terjadi dapat bersifat permanen maupun dapat
                  dikembalikan, dan deteksi dini dapat menjadi salah satu faktor
                  penentu gangguan mana yang dimiliki seseorang. Penanganan dini
                  dapat mengembalikan beberapa fungsi kognitifnya atau
                  setidaknya memperlambat jalannya progres gangguan. Oleh karena
                  itu penting untuk mengenali gejala awal Alzheimer. Deteksi
                  awal penyakit Alzheimer dapat dilakukan dengan melihat
               ...
               <p>
                  Selain melihat gejala-gejala di atas deteksi awal Alzheimer
                  dapat dilakukan melalui wawancara dan beberapa pemeriksaan.
                  Pemeriksaan yang dilakukan adalah untuk menilai kemampuan
                  mengingat, perubahan sikap, derajat gangguan ingatan yang
                  terjadi, hingga penyebab dari keluhan. Pemeriksaan yang sampai
                  saat ini sudah terbukti akurat hingga 84 persen adalah
